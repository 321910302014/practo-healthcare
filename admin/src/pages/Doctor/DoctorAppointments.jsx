  ...
  return (
    <div className='w-full max-w-6xl m-5 '>
      ...
      <div className='bg-white border rounded text-sm max-h-[80vh] overflow-y-scroll'>
        <div className='max-sm:hidden grid grid-cols-[0.4fr_1.8fr_0.8fr_0.6fr_2.4fr_0.8fr_0.9fr_1.8fr] gap-1 py-3 px-6 border-b font-medium'>
          <p>#</p>
          <p>Patient</p>
          <p>Payment</p>
          <p>Age</p>
        ...
        {appointments.map((item, index) => (
          <React.Fragment key={index}>
            <div className='flex flex-wrap justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[0.4fr_1.8fr_0.8fr_0.6fr_2.4fr_0.8fr_0.9fr_1.8fr] gap-1 items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50'>
                  ...
                  : <div className='flex flex-wrap items-center gap-1.5'>
                    ...
                    {item.videoConsultation && (
                      <button
                        ...
                        className="px-2 py-1 bg-green-600 hover:bg-green-700 text-white text-[10px] font-bold rounded whitespace-nowrap"
                      >
                        📹 Join
                      </button>
                    )}
